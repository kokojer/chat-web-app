...
export type GetUserQuery = { __typename?: 'Query', getUser: { __typename?: 'User', firstName: string, lastName: string, username: string, id: number } };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'LoginResponse', access_token: string, user: { __typename?: 'User', username: string, firstName: string, lastName: string, userId: number } } };
...
export type SignupMutation = { __typename?: 'Mutation', signup: { __typename?: 'LoginResponse', access_token: string, user: { __typename?: 'User', username: string, firstName: string, lastName: string, userId: number } } };
...
export type GetUserByOccurrencesQuery = { __typename?: 'Query', getUsersByOccurrences: Array<{ __typename?: 'User', firstName: string, lastName: string, username: string, userId: number }> };
...
export const GetUserByOccurrencesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getUserByOccurrences"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"nameOrUsername"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getUsersByOccurrences"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"nameOrUsername"},"value":{"kind":"Variable","name":{"kind":"Name","value":"nameOrUsername"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","alias":{"kind":"Name","value":"userId"},"name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<GetUserByOccurrencesQuery, GetUserByOccurrencesQueryVariables>;
